...
namespace TMXMapEditorTest
{
    ...
    public class Camera2d
    {
        ...
        public float LeftBarrier
        {
            get
            {
                return (float)_viewportWidth * .5f / _zoom;
            }
        }
        ...
        public float RightBarrier
        {
            get
            {
                return _worldWidth -(float)_viewportWidth * .5f / _zoom;
            }
        }
        ...
        public float TopBarrier
        {
            get
            {
                return _worldHeight - (float)_viewportHeight * .5f / _zoom;
            }
        }
        ...
        public float BottomBarrier
        {
            get
            {
                return (float)_viewportHeight *.5f / _zoom;
            }
        }
