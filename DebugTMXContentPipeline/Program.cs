...
namespace DebugPipeline1
{
    ...
    class Program
    {
        ...
        /// </summary>
        private const string ProjectToDebug = @"C:\windowsphonedevelopments\TMXMapLoaderXNA\TMXMapLoaderXNA\TMXMapEditorTest\TMXMapEditorTestContent\TMXMapEditorTestContent.contentproj";
        ...
        /// </summary>
        private const string SingleItem = @"perspective_walls.tmx";
